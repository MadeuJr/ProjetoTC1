function setFormAddVeiculo() {

    let xml = '<form class="pure-form border">' +
        '<fieldset>' +
...
function setFormDeleteVeiculo() {

    xml = '<form class="pure-form border">' +
        '<fieldset>' +
